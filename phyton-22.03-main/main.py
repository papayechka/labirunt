...
class Player(GameSprite):
   ...
   def fire(self):
       bullet = Bullet('orange.png',self.rect.right,self.rect.centery,30,30,15)
       bullets.add(bullet)
class Enemy(GameSprite):
    direction="left"
    def __init__(self,enemy_image,enemy_x,enemy_y,size_x,size_y,enemy_speed,min_x):
...
monster_w = GameSprite('platform_m.png',420, 450, 47, 100) #Вертикальна
monster_w1 = GameSprite('platform_m.png',330, 160, 47, 90) #Вертикальна
...
monster = Enemy('virus.png', win_width - 80, 168, 80, 80,2,360)
# monster1 = GameSprite('virus.png', win_width - 80, 90, 80, 80,)
# monster2 = GameSprite('virus.png', win_width - 500, 450, 80, 80)
monster3 = Enemy('virus.png', win_width -100, 700, 80, 80,5,500)
final_sprite = GameSprite('banana.png',50 , 450, 80, 80)

monsters.add(monster)
# monsters.add(monster1)
# monsters.add(monster2)
monsters.add(monster3)
monsters.add(monster_w)
monsters.add(monster_w1)
